...
Additionally, you can consider the failure messages from automated unit-test on the student current student state. They can hint at problems in the student could.
