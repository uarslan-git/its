...
#!json!#
{
    ...
    "choice_explanations": ["This statement is correct. In HMM, the states of the system are hidden, hence the name.", 
                            ...
                            "This statement is not completely correct.  HMMs are used for modeling sequential data, where the underlying system is assumed to be in one of a finite set of hidden states at each time step, while VAE tries to learn the distribution of latent representations of the data, which grants it generative power. However, VAEs can be extended to handle sequential data, too.",
