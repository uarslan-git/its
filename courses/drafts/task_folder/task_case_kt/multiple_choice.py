...
#!json!#
{
    "possible_choices": [ "Bayesian Knowledge Tracing (BKT), which estimates the probability that a student has mastered a skill based on their sequence of correct and incorrect responses.",
                        ...
                        "1 parameter IKT model to understand the difficulty of each item in the quizzes.",
                        "2 parameter IKT model to understand the difficulty and discrimination of each item in the quizzes.",
